...
export default function FormalLinks() {
  const className = "text-[13px] leading-4";

  return (
    <div>
      <ul className="flex flex-col  gap-[3px] mt-4 mx-6">
        <li className="flex gap-4 justify-center items-center">
          <GeneralLink onClick={showNotAvailableToast}>
            <span className={className}>About</span>
          </GeneralLink>
          <GeneralLink onClick={showNotAvailableToast}>
            <span className={className}>Accessibility</span>
          </GeneralLink>
          <GeneralLink onClick={showNotAvailableToast}>
            <span className={className}>Help Center</span>
          </GeneralLink>
        </li>
        <li className="flex gap-4 justify-center items-center">
          <GeneralLink onClick={showNotAvailableToast}>
            <div className="flex items-center justify-center gap-[2px]">
              <span className={className}>{"Privacy & Terms"}</span>
          ...
          <GeneralLink onClick={showNotAvailableToast}>
            <span className={className}>Ad Choises</span>
          </GeneralLink>
        </li>
        <li className="flex gap-4 justify-center items-center">
          <GeneralLink onClick={showNotAvailableToast}>
            <span className={className}>Advertising</span>
          </GeneralLink>
          <GeneralLink onClick={showNotAvailableToast}>
            <div className="flex items-center justify-center gap-[2px]">
              <span className={className}>{"Business Services"}</span>
        ...
        <li className="flex gap-4 justify-center items-center">
          <GeneralLink onClick={showNotAvailableToast}>
            <span className={className}>Get the LinkedIn app</span>
          </GeneralLink>
          <GeneralLink onClick={showNotAvailableToast}>
      ...
      <div className=" py-4 px-6 flex items-center justify-center gap-1">
